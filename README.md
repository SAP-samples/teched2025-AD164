...
<!--
> [!NOTE]  
> [SAP TechEd 2025 | AD164 – Get started with ABAP Cloud for classic ABAP developers](https://www.sap.com/events/teched/berlin/flow/sap/te25/catalog-inperson/page/catalog/session/1749112624677001Rt0T)    
> Familiar with classic ABAP development? Explore how similar development works with ABAP Cloud using the ABAP RESTful application programming model (RAP). Use ABAP Cloud to build cloud-ready business apps, services, and extensions that follow clean core principles by default on SAP Business Technology Platform and in any edition of SAP S/4HANA.
-->
...
In this workshop, you’ll get hands-on experience with ABAP Cloud using the ABAP RESTful application programming model (RAP), the programming model for transactional scenarios. Building on your knowledge of classic ABAP, you’ll explore based on the present scenario how to develop cloud-ready business applications and extensions that follow clean core principles. You will rebuild an existing ALV-based app as an SAP Fiori elements app with ABAP Cloud and extend it further with new capabilities. 

> [!NOTE]  
> Please note that the focus of this hands-on workshop is on backend development – specifically, developing OData UI services, including the UI semantics for the SAP Fiori elements UI – rather than on Fiori UI development.  
